        ...
        <div class="lg:flex lg:items-center lg:-mx-6">
            <div class="lg:w-1/2 lg:mx-6">
                ...
                <div class="mt-6 space-y-8 md:mt-8">
                    <p class="flex items-start -mx-2" data-aos="fade-right" data-aos-duration="1000">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 mx-2 text-yellow-400 dark:text-yellow-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <p class="flex items-start -mx-2" data-aos="fade-right" data-aos-duration="1500">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 mx-2 text-yellow-400 dark:text-yellow-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <p class="flex items-start -mx-2" data-aos="fade-right" data-aos-duration="2000">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 mx-2 text-yellow-400 dark:text-yellow-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <div class="mt-6 w-80 md:mt-8">
                    <h3 class="text-gray-600 dark:text-gray-300 " data-aos-duration="5000">Suivez-nous</h3>

                    <div class="flex mt-4 -mx-1.5 ">
                        <a class="mx-1.5 dark:hover:text-yellow-400 text-gray-400 transition-colors duration-300 transform hover:text-yellow-400" href="#" data-aos="fade-up" data-aos-duration="1000">
                        ...
                        <a class="mx-1.5 dark:hover:text-yellow-400 text-gray-400 transition-colors duration-300 transform hover:text-yellow-400" href="#" data-aos="fade-up" data-aos-duration="1300">
                        ...
                        <a class="mx-1.5 dark:hover:text-yellow-400 text-gray-400 transition-colors duration-300 transform hover:text-yellow-400" href="#" data-aos="fade-up" data-aos-duration="1500">
                            <svg class="w-8 h-8" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M7 10.2222V13.7778H9.66667V20H13.2222V13.7778H15.8889L16.7778 10.2222H13.2222V8.44444C13.2222 8.2087 13.3159 7.9826 13.4826 7.81591C13.6493 7.64921 13.8754 7.55556 14.1111 7.55556H16.7778V4H14.1111C12.9324 4 11.8019 4.46825 10.9684 5.30175C10.1349 6.13524 9.66667 7.2657 9.66667 8.44444V10.2222H7Z" fill="currentColor" />
                            </svg>
                        </a>

                        <a class="mx-1.5 dark:hover:text-yellow-400 text-gray-400 transition-colors duration-300 transform hover:text-yellow-400" href="#" data-aos="fade-up" data-aos-duration="1700">
                            <svg class="w-8 h-8" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="mt-8 lg:w-1/2 lg:mx-6" data-aos="fade-left">
                <div
                    class="w-full px-8 py-10 mx-auto overflow-hidden  rounded-lg shadow-2xl dark:bg-yellow-50 lg:max-w-xl shadow-yellow-300/50 dark:shadow-yellow-400">
