...
export default function number() {
  ...
  return (
    <section class="py-10 bg-gradient-to-t from-yellow-100 to-white dark:to-gray-900 sm:py-16 lg:py-24">
    <div class="max-w-5xl px-4 mx-auto sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 gap-8 mt-10 text-center lg:mt-24 sm:gap-x-8 md:grid-cols-4">
            <div data-aos="zoom-in">
                ...
                <p class="mt-4 text-xl font-medium text-gray-900 dark:text-neutral-700">VENTES DE BOISSONS</p>
            ...
            <div data-aos="zoom-in">
                ...
                <p class="mt-4 text-xl font-medium text-gray-900 dark:text-neutral-700">TICKET MOYEN</p>
            ...
            <div data-aos="zoom-in">
                ...
                <p class="mt-4 text-xl font-medium text-gray-900 dark:text-neutral-700">VENTES SUPPLÉMENTAIRES</p>
            ...
            <div data-aos="zoom-in">
                ...
                <p class="mt-4 text-xl font-medium text-gray-900 dark:text-neutral-700">HAUSSE DES VENTES</p>
