  ...
  return (
    ...
    <div class="max-w-5xl px-4 mx-auto sm:px-6 lg:px-8">
        <div class="max-w-2xl mx-auto text-center" data-aos="fade-down">
            <h3 class="text-2xl font-bold leading-tight text-black sm:text-4xl lg:text-4xl">Chez certains de <span className='underline decoration-yellow-400'>nos clients</span></h3>
           </div>
        ...
        <div class="grid grid-cols-1 gap-8 mt-10 text-center lg:mt-24 sm:gap-x-8 md:grid-cols-4">
            <div data-aos="zoom-in">
                ...
                <p class="mt-4 text-xl font-medium text-gray-900">VENTES DE BOISSONS</p>
            ...
            <div data-aos="zoom-in">
                ...
                <p class="mt-4 text-xl font-medium text-gray-900">TICKET MOYEN</p>
            ...
            <div data-aos="zoom-in">
                ...
                <p class="mt-4 text-xl font-medium text-gray-900">VENTES SUPPLÉMENTAIRES</p>
            ...
            <div data-aos="zoom-in">
                ...
                <p class="mt-4 text-xl font-medium text-gray-900">HAUSSE DES VENTES</p>
