...
<div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 mt-5 ">
  ...
  <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
    ...
    <div  data-aos="fade-right">
      <h1 class="block font-bold text-gray-800 sm:text-4xl  lg:leading-tight dark:text-white"><span class="text-transparent bg-clip-text bg-gradient-to-r from-orange-300 to-yellow-400">DBSYS SERVICES </span> Excellence Technique et Passion au Service de Votre Entreprise </h1>
