...
export default function Products() {
  ...
  return (
    <div>
      <h1 className="text-2xl  text-center text-transparent bg-clip-text bg-gradient-to-r from-orange-300 to-yellow-400 dark:bg-gradient-to-r  dark:from-orange-300 dark:to-yellow-400   " data-aos="zoom-in">Nouveautés</h1>
